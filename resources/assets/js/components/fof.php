<form id="billing-form" method="POST" action="{{ route('login') }}" >
    ...
    <fieldset class="box">
        ...
        <p :class="{ 'control': true }">
            ...
            <input type="text" name="name" id="name" v-validate="'required|min:3'" value=""  placeholder="Full Name" class="input" :class="{'input': true, 'is-danger': errors.has('email') }" v-model="model.name">
        </p>


        <p :class="{ 'control': true }">
            <span v-if="errors.has('email')" class="help is-danger">@{{ errors.first('email') }}</span>
            <input type="text" name="email" id="email" v-validate="'required|email'" value=""  placeholder="Email" class="input" :class="{'input': true, 'is-danger': errors.has('email') }" v-model="model.email">
        </p>

        <p :class="{ 'control': true }">
            <span v-if="errors.has('address')" class="help is-danger">@{{ errors.first('address') }}</span>
            <input type="text" name="address" id="address" v-validate="'required|min:3'" value=""  placeholder="Address" class="input" :class="{'input': true, 'is-danger': errors.has('address') }" v-model="model.address">
        </p>


        <div class="control"><input type="text" name="city" id="city" value="" placeholder="City" required="required" class="input"></div>
...
Zimbabwe
        ...
        <div class="control">
            <input type="text" name="phone" id="state" value="" placeholder="Tel Number" class="input"></div>
        <div><input type="hidden" name="stripeToken"> <div class="control is-grouped">
                <p class="control">
                    <button type="button"  @click="validateBeforeSubmit"  class="button is-primary">Sign Up</button></p>
